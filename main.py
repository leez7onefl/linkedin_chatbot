...
st.set_page_config(page_title="Leonard's Assistant", page_icon="🤖", layout="wide")
...
def refine_response(text, prompt, model="gpt-4", max_length=1024):
    try:
        response = openai.chat.completions.create(
            model=model,
            messages=[
                {"role": "system", "content": "You speak in the tone of a friendly assistant of leonard gonzalez."},
